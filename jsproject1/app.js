...
function c() {
 ...
 let States = {currentState: 'start', possibleStates: ['start',
 'deathByHunger', 'lunarBase', 'vampireRoom', 'deathByVampire',
 'turnedIntoVampire', 'escortedOutByVampire']}
 ...
 // Make a look function that tells the player what they see depending
