var george = ["English", 26, 87, "comedian", "pasta", new Date('December 22 1992 12:24:17'), new Date('January 31 2079 07:05:19')];
//  declaring is creating a variable
//  assigning is storing somethings into a variable

//  1)  Use the length property on each of the following lists:
//  a)
console.log(george);
console.log(george.length);

//  b)
var butthole=["α","β","ψ","δ","ε","φ","γ","η","ι","ξ","κ","λ","μ","ν","ο","π",";","ρ","σ","τ","θ","ω","ς","χ","υ","ζ"];
console.log(butthole.length);

//  c)
var ass=['16-bit', 'shooter', 1993, 'Data East', 'Bren McGuire', 'The Machine', 'IGN rating: ', 7.5];
console.log(ass.length);

//  d)
var fragileMageData=[['health', [76, 120], 1, 1, 0, 1, 'Health Bar'], ['magic', [7263, 9001], 0, 1, 1, 0, 'Mana'], ['energy', [0, 0], 1, 0, 1, 0, 'Not a melee!']];
console.log(fragileMageData.length);

//  2)  Obtain the following values using indexing of the above lists:
//  a)  The birth date of George
console.log(george[5]);

//  b)  The death date of George
console.log(george[6]);

//  c) The 14th letter of the Greek alphabet
console.log(butthole[13]);

//  d)  The letter rho (ρ)
console.log(butthole[17]);
