...
// let val1 = "I have this string...".indexOf('12');

// console.log(val1);

// The result is "-1". I found it by using the console output. The result is an index of -1.
...
// let val = "Changing case (capitalization and uncapitalization)".indexOf('27');
